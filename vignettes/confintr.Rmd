...
{confintr} is dedicated to classic and/or bootstrap confidence intervals (CI). The following parameters are covered:
...
4. Bias-corrected and accelerated ("bca") CI: Refined version of the percentile bootstrap which is second-order accurate and transformation respecting. Needs more replications than observations. **The default** (except for the mean and the mean difference, see below).
